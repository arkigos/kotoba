...
export function exactDuplicateFindings(unit, options = {}) {
  const maxExactLineRepeats = options.maxExactLineRepeats ?? 2;
  const maxExactEnglishRepeats = options.maxExactEnglishRepeats ?? 2;
...
export function assertUnitVariety(unit, options = {}) {
  ...
  if (duplicateFindings.length > 0 || axisFindings.length > 0) {
    const messages = [
