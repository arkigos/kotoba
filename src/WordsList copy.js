...
function WordsList() {
  ...
  // Function to check for cookie consent (you'll need to implement this)
  const hasCookieConsent = () => {
    // Check if the user has already consented to cookies
    // You can use localStorage, a cookie, or any other method
    // For example, check if a "cookieConsent" cookie is set
