...
- Add an A2 enforcement pass for current vocabulary, review-due vocabulary presence, grammar pacing, and visible question markers.
...
- A2 review-due vocabulary returns in the unit.
...
- Rebuilt frozen A2 Units 21-44 with current vocabulary landing cards and guaranteed review-due returns.
