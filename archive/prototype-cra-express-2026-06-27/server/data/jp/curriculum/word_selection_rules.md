...
3. Compute the available word bin for unit `N`: words from units `N`, `N-2`,
   `N-4`, `N-8`, `N-16`, `N-32`, and so on.
4. Choose 10 new words that pair naturally with the grammar focus and with the
   older words in the available bin.
...
If a word is needed again, use it from the available word bin or prior grammar
permissions; do not list it as new.
...
- Older available-bin words can combine naturally with the new words.
